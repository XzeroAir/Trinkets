...
public interface IAttributeConfigHelper {
	...
	boolean JumpAttributeEnabled();

	int JumpAttributeOperation();

	double JumpAttributeAmount();

	boolean StepHeightAttributeEnabled();

	int StepHeightAttributeOperation();

	double StepHeightAttributeAmount();
