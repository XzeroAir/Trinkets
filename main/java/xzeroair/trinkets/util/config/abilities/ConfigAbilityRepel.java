...
public class ConfigAbilityRepel {

    private final String LANG_PREFIX = ConstantsConfigLang.CONFIG_ABILITIES_REPEL;

    public ConfigAbilityRepel() {
        this(10F, 20);
    }

    public ConfigAbilityRepel(float cost, int ticks) {
        this.COST = cost;
    ...
    @Config.Ignore
    @Config.Name("04. Invert Whitelist")
    @Config.LangKey(ConstantsConfigLang.CONFIG_WHITELIST_INVERTED)
    public boolean WHITELIST_INVERTED = false;

    @Config.Name("05. " + ConstantsConfigLang.CONFIG_WHITELIST_NAME)
