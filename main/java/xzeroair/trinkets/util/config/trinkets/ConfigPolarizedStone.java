...
public class ConfigPolarizedStone {
    ...
    private final String LANG_PREFIX = ConstantsConfigLang.CONFIG_ITEMS_POLARIZED_STONE;

    public ConfigPolarizedStone() {
    ...
    public class ConfigAbilities {
        ...
        @Config.Name(ConstantsConfigLang.CONFIG_ABILITIES_MAGNETIC_NAME)
        @Config.Comment(ConstantsConfigLang.CONFIG_ABILITIES_MAGNETIC_COMMENT)
        ...
        @Config.Name(ConstantsConfigLang.CONFIG_ABILITIES_REPEL_NAME)
        @Config.Comment(ConstantsConfigLang.CONFIG_ABILITIES_REPEL_COMMENT)
