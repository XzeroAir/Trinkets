...
public class ConfigExpDevice {

//	private final String LANG_PREFIX = ConstantsConfigLang.CONFIG_ITEMS_;

    public ConfigExpDevice() {
...
//		@Config.Name("00. " + ConstantsConfigLang.CONFIG_ABILITIES_NAME)
//		@Config.Comment(ConstantsConfigLang.CONFIG_ABILITIES_COMMENT)
//		@Config.LangKey(ConstantsConfigLang.CONFIG_ABILITIES)

    }

    @Config.Name(ConstantsConfigLang.CONFIG_RESISTANCES_NAME)
    ...
    @Config.Name(ConstantsConfigLang.CONFIG_DAMAGE_TYPES_NAME)
    ...
    @Config.Name(ConstantsConfigLang.CONFIG_ATTRIBUTES_NAME)
