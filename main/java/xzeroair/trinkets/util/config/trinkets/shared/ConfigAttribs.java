...
public class ConfigAttribs implements IAttributeConfigHelper {
	...
	public ConfigAttribs(
			...
			boolean jump, double jumpAmount, int jumpOperation,
			boolean stepHeight, double stepHeightAmount, int stepHeightOperation) {
		...
		stepHeight_amount = stepHeightAmount;
		stepHeight_operation = stepHeightOperation;
	...
	@Name("Jump Height Amount")
	@LangKey(jumpKey + amountKey)
	public double jump_amount = 0D;

	@Config.Comment("Determines the Math used for the Attribute Modifier")
	@Name("Jump Height Operation")
	@LangKey(jumpKey + operationKey)
	public int jump_operation = 0;

	@Config.Comment("Enable Attribute Modifier")
	@Name("Step Height")
	@LangKey(stepHeightKey)
	public boolean stepHeight = false;

	@Name("Step Height Amount")
	@LangKey(stepHeightKey + amountKey)
	public double stepHeight_amount = 0D;

	@Config.Comment("Determines the Math used for the Attribute Modifier")
	@Name("Step Height Operation")
	@LangKey(stepHeightKey + operationKey)
	public int stepHeight_operation = 0;
	...
	public int StepHeightAttributeOperation() {
		return stepHeight_operation;
	}

	@Override
	public double StepHeightAttributeAmount() {
		return stepHeight_amount;
	}
