...
public class FairyConfig {
    ...
    private final String LANG_PREFIX = ConstantsConfigLang.CONFIG_RACES_FAIRY;
    ...
    public RaceMagicConfig MAGIC = new RaceMagicConfig(500);
    ...
    public RaceSizeConfig SIZE = new RaceSizeConfig(25, 25);
