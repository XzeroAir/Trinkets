...
//			public BaubleCompat baubles = new BaubleCompat("ring");
		...
		private final double 	damageAmount = -0.75D;
		private final int		damageOperation = 2;
		private final boolean 	health = true;
		private final double 	healthAmount = -0.6D;
		...
		private final double 	swimSpeedAmount = -0.25D;
		...
		private final double	jumpAmount = -0.25;
		private final int		jumpOperation = 2;
		private final boolean	stepHeight = true;
		private final double	stepHeightAmount = -0.35;
