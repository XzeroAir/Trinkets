...
public class Wings extends ModelBase {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":" + "textures/races/fairy/fairy_wings_fake.png");
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (((entityIn.motionX >= v) || (entityIn.motionZ >= v)) || (((entityIn.motionX <= -v) || (entityIn.motionZ <= -v))) || !entityIn.onGround) {
            ...
            if (!entityIn.onGround && !entityIn.isRiding()) {
                ...
                final float[][] Cycle = new float[][]{{f4, 0f, 0f}, {f3, 0F, 0f}, {f2, 0F, 0F}, {f1, 0F, 0F}, {f, 0F, 0F}, {f, 0F, 0F}, {f1, 0F, 0F}, {f2, 0F, 0F}, {f3, 0F, 0F}, {f4, 0F, 0F},};
