...
public class Tiara extends ModelBiped {
    ...
    public Tiara() {
        ...
        this.setRotateAngle(this.Tiara1Right, 0.0F, 0.5061454830783556F, 0.0F, 1F);
        ...
        this.setRotateAngle(this.Tiara1Left, 0.0F, -0.5061454830783556F, 0.0F, 1F);
        ...
        this.setRotateAngle(this.Tiara2Right, 0.0F, 1.0122909661567112F, 0.0F, 1F);
        ...
        this.setRotateAngle(this.Tiara2Left, 0.0F, -1.0122909661567112F, 0.0F, 1F);
        ...
        this.setRotateAngle(this.Tiara3Left, 0.0F, -1.5707963267948966F, 0.0F, 1F);
        ...
        this.setRotateAngle(this.Tiara3Right, 0.0F, 1.5707963267948966F, 0.0F, 1F);
        ...
        this.setRotateAngle(this.Tiara4Right, 0.0F, 0.5061454830783556F, 0.0F, 1F);
        ...
        this.setRotateAngle(this.Tiara4Left, 0.0F, -0.5061454830783556F, 0.0F, 1F);
    ...
    public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float yaw, float pitch, float scale, float partialTicks) {
        this.setRotateAngle(this.Tiara, 0, 0, 0, scale);
        float sneak = (this.isSneak ? 0.2F : 0F);
        this.Tiara.offsetX = 0;
        this.Tiara.offsetY = 0;//-0.04F;//-0.62F;
        this.Tiara.offsetZ = 0;//0.01F;//0.01F;
        this.Tiara.rotationPointX = 0F;
        this.Tiara.rotationPointY = 0F;
        this.Tiara.rotationPointZ = 0F;
        ...
        if (this.equippedAsAccessory) {
            ...
            this.Tiara.render(scale);
            this.Tiara.postRender(scale);
        } else {
            ...
            try {
                ...
                if (model != null) {
                    model = model.getOverrides().handleItemState(model, ItemStack.EMPTY, null, null);
                    ...
                    if (model.isBuiltInRenderer()) {
                        ...
                        for (EnumFacing enumfacing : EnumFacing.values()) {
                            renderer.renderQuads(bufferbuilder, model.getQuads(null, enumfacing, 0L), -1, ItemStack.EMPTY);
                        }

                        renderer.renderQuads(bufferbuilder, model.getQuads(null, null, 0L), -1, ItemStack.EMPTY);
                        tessellator.draw();
