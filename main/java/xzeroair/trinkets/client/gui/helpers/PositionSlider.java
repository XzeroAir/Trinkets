...
public class PositionSlider {
    ...
    public PositionSlider(GuiEntityProperties parent, int id, int x, int y, int width, int height, double posX, double posY, double posZ, FontRenderer fontRenderer) {
        this(parent, id, x, y, width, height, posX, posY, posZ, fontRenderer, null);
    }

    public PositionSlider(GuiEntityProperties parent, int id, int x, int y, int width, int height, double posX, double posY, double posZ, FontRenderer fontRenderer, Consumer<Double> posChanged) {
        this.parent = parent;
        ...
        this.width = width;
        this.height = height;
        this.posX = new GuiPropertiesSlider(id++, x, y + (height) + 1, width + 22, height, "X: " + posX, (float) posX, 1F, 0F, (sliderR) -> {
...
//            }
        ...
        this.posY = new GuiPropertiesSlider(id++, x, y + (height * 2) + 1, width + 22, height, "G: " + Math.round(posY * 255), (float) posY, 1F, 0F, (sliderG) -> {
...
//            }
        ...
        this.posZ = new GuiPropertiesSlider(id++, x, y + (height * 3) + 1, width + 22, height, "B: " + Math.round(posZ * 255), (float) posZ, 1F, 0F, (sliderB) -> {
