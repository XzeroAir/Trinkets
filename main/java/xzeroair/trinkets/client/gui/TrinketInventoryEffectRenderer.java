...
public class TrinketInventoryEffectRenderer extends TrinketGuiContainer {
	...
	private void drawActivePotionEffects() {
		...
		final int multi = MathHelper.ceil(slots / 8.0);
		final int offset = (18 * (multi));
		final int i = (((guiLeft - xPos) + 5) - 140) - (offset);//(guiLeft - (118 + (16 * TrinketsConfig.SERVER.GUI.guiSlotsRows))) + xPos;//TrinketsConfig.CLIENT.button.Xoffset;
		int j = guiTop;// + yPos;
		final int k = 166;
