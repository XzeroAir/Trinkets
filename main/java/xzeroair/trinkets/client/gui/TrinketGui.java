...
public class TrinketGui extends TrinketInventoryEffectRenderer {
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
	{
		...
		final float[] gColor = ColorHelper.getHexColor(TrinketsConfig.CLIENT.GUI.GuiColor);

		final float gr = gColor[0];
		final float gg = gColor[1];
		final float gb = gColor[2];
		final float ga = gColor[3];
		...
		final int bX = TrinketsConfig.CLIENT.GUI.button.X;
		final int bY = TrinketsConfig.CLIENT.GUI.button.Y;
		...
		GlStateManager.color(1, 1, 1, 1);
		GuiInventory.drawEntityOnScreen(k + 51, l + 75, 30, (k + 51) - oldMouseX, (l + 75) - 50 - oldMouseY, mc.player);
	}
