...
public class RaceGoblinEars implements IRenderModelInterface {

    public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":" + "textures/races/goblin/ears.png");
...
//    public static final ResourceLocation TEXTURE_OUTER = new ResourceLocation(Reference.MODID + ":" + "textures/outer_ears.png");
    ...
    public static RaceGoblinEars INSTANCE = new RaceGoblinEars();
