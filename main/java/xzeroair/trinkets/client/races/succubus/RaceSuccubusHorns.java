package xzeroair.trinkets.client.races.succubus;
...
public class RaceSuccubusHorns implements IRenderModelInterface {

    public static final BipedJsonModel SUCCUBUS_HORNS = new BipedJsonModel(new ResourceLocation(Reference.MODID, "race/succubus/succubus_horns"));

    public static RaceSuccubusHorns INSTANCE = new RaceSuccubusHorns();
    ...
    public void render(@Nonnull EntityLivingBase entity, RenderLivingBase renderer, boolean isFake, boolean isSlim, float partialTicks, float scale, int variant, int colorPrimary, int colorSecondary, int auxColor) {
        ...
        GlStateManager.translate(-8F * scale, -4.4F * scale, 3F * scale);
        GlStateManager.color(1, 1, 1, 1);
