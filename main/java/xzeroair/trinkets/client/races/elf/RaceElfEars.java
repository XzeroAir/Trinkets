...
public class RaceElfEars implements IRenderModelInterface {

    public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":" + "textures/races/elf/ears.png");
...
//    public static final ResourceLocation TEXTURE_OUTER = new ResourceLocation(Reference.MODID + ":" + "textures/outer_ears.png");
    ...
    public static RaceElfEars INSTANCE = new RaceElfEars();
