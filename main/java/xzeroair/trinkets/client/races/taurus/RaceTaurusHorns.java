...
public class RaceTaurusHorns implements IRenderModelInterface {

    public static final BipedJsonModel TUARIAN_HORNS = new BipedJsonModel(new ResourceLocation(Reference.MODID, "race/taurus/tuarian_horns"));

    public static final RaceTaurusHorns INSTANCE = new RaceTaurusHorns();
