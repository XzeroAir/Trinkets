...
import xzeroair.trinkets.api.events.TrinketsRegistryEvent.RegisterAbilitiesEvent;
...
public class Ability implements IAbilityInterface {
	...
	public List<String> getDescription() {
		...
		TranslationHelper.addToolTips(this.getTranslationKey(), list);
		return list;
	}
	...
	private static void registerAbility(int id, IAbilityInterface ability) {
		registerAbility(id, new ResourceLocation(Reference.MODID, ability.getName()), ability);
	}
