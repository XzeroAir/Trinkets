...
public class AbilityChargedShot extends AbilityBase implements ITickableAbility, IBowAbility, IAttackAbility {
	...
	@Override
	public ActionResult<ItemStack> knockArrow(EntityLivingBase entity, World world, ItemStack bow, EnumHand hand, ActionResult<ItemStack> action, boolean hasAmmo) {
	...
	// Client and Server
	@Override
	public void looseArrow(EntityLivingBase entity, World world, ItemStack bow, int weight) {

	}

	@Override
	public void arrowImpact(EntityLivingBase entity, EntityArrow arrow, RayTraceResult rayTraceResult) {
