...
public class AbilityNullKinetic extends Ability implements IAttackAbility, IJumpAbility {
    ...
    public AbilityNullKinetic() {
        this(TrinketsConfig.SERVER.ABILITIES.NULL_KINETIC);
    }

    public AbilityNullKinetic(ConfigAbilityKinetic config) {
        super(TrinketsRegistryNames.ModAbilities.NULLIFY_KINETIC);
        this.CONFIG = config;
