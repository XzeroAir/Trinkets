    ...
    public void tickAbility(EntityLivingBase entity) {
        if (serverConfig.underwater_breathing) {
            ...
            if (!serverConfig.always_full) {
                ...
                if (TrinketsConfig.getClientStore().MOD_COMPAT_BETTER_DIVING) {
        ...
        if ((!TrinketsConfig.getClientStore().MOD_COMPAT_BETTER_DIVING) && (serverConfig.Swim_Tweaks == true) && !this.isSpectator(entity) && !this.isCreativeFlying(entity)) {
