...
public abstract class AbilityBreathBase extends Ability implements IKeyBindInterface {
    ...
    public AbilityBreathBase(String registryName, ConfigAbilityBreath config) {
        super(registryName);
        this.CONFIG = config;
    ...
    protected boolean DragonBreath(Entity entity) {
        ...
        if (this.BREATH_STAGE == 0) {
            ...
            int bcolor = this.getBreathColor(entity);
