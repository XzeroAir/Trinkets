...
public class Faelis_Food extends FoodBase {

	public Faelis_Food(String name) {
		super(name, 5, 0);
		this.setAlwaysEdible();
		this.setUUID("3f74acc4-b71b-42d4-87c3-d1992fd68b6e");
	}
		...
		if (entityLiving instanceof EntityPlayer) {
			...
			if (prop != null) {
				if (TrinketsConfig.SERVER.Food.food_effects) {
					if (!(prop.getImbuedRace().equals(EntityRaces.faelis))) {
						prop.setImbuedRace(EntityRaces.faelis);
