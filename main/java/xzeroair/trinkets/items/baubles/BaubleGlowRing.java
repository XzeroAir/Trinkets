...
public class BaubleGlowRing extends TrinketGlowRing implements IBauble {

	public BaubleGlowRing(String name) {
		super(name);
	...
	public BaubleType getBaubleType(ItemStack itemstack) {
		return BaubleHelper.getBaubleType(TrinketsConfig.SERVER.GLOW_RING.compat.baubles.bauble_type);
	}
	@Override
