...
public class BaubleFairyRing extends TrinketFairyRing implements IBauble {

	public BaubleFairyRing(String name) {
		super(name);
	...
	public BaubleType getBaubleType(ItemStack itemstack) {
		return BaubleHelper.getBaubleType(TrinketsConfig.SERVER.FAIRY_RING.compat.baubles.bauble_type);
	}
