...
public class BaubleTitanRing extends TrinketTitanRing implements IBauble {

	public BaubleTitanRing(String name) {
		super(name);
	...
	public BaubleType getBaubleType(ItemStack itemstack) {
		return BaubleHelper.getBaubleType(TrinketsConfig.SERVER.TITAN_RING.compat.baubles.bauble_type);
	}
