...
public class BaubleGreaterInertia extends TrinketGreaterInertia implements IBauble {

	public BaubleGreaterInertia(String name) {
		super(name);
	...
	public BaubleType getBaubleType(ItemStack itemstack) {
		return BaubleHelper.getBaubleType(TrinketsConfig.SERVER.GREATER_INERTIA.compat.baubles.bauble_type);
	}
	@Override
