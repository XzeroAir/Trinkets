...
public class BaublePolarized extends TrinketPolarized implements IBauble {

	public BaublePolarized(String name) {
		super(name);
	...
	public BaubleType getBaubleType(ItemStack itemstack) {
		return BaubleHelper.getBaubleType(TrinketsConfig.SERVER.POLARIZED_STONE.compat.baubles.bauble_type);
	}
	@Override
