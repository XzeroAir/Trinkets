    ...
    public int getTeddyVariant(ItemStack stack) {
        if ((stack != null) && !stack.isEmpty()) {
            ...
            if ((crafterID.equalsIgnoreCase("b4817e56-db30-4fdb-9c4c-bba3e0378e0a") && !hasDisplayName) || name.contains("rixxi")) {
                ...
                return 6;
            } else if ((crafterID.equalsIgnoreCase("5a215d65-e57d-47c6-a322-9ede12a4a100") && !hasDisplayName) || name.contains("potastic") || name.contains("potasticP") || name.contains("panda")) {
                return 5;
